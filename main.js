...
document.querySelectorAll('a, button, .cert-card, .exp-card, .contact-card').forEach(el => {
...
// ---- CARD TILT EFFECT ----
document.querySelectorAll('.exp-card, .timeline-card, .skill-category').forEach(card => {
